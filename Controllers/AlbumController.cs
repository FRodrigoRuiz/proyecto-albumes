...
namespace Albumes.Controllers
{
    public class AlbumController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Author,Year,Story,Cover")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Author,Year,Story,Cover")] Album album)
        {
            if (id != album.Id)
            {
                return NotFound();
